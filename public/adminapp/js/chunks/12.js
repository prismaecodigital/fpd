...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])('AdditionalLimitsIndex', ['fetchIndexData', 'setQuery', 'resetState']))
});
...
var render = function render() {
  ...
  }, [_c("strong", [_vm._v(_vm._s(_vm.$t("cruds.additional-limit.title")) + " Limit COA " + _vm._s(this.selected_bu.code))])]), _vm._v(" "), _c("div", {
    staticClass: "card-body"
  }, [_c("p", {
    staticStyle: {
      color: "black"
    }
  }, [_vm._v("\n              Daftar Penambahan Limit pada COA " + _vm._s(this.selected_bu.code) + "\n            ")])])]), _vm._v(" "), _c("div", {
    staticClass: "card-body"
