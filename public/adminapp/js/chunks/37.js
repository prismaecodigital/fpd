...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])('FpdsSingle', ['entry'])),
  watch: {
    '$route.params.id': {
      immediate: true,
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.fpd.fields.id")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.id) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.fpd.fields.code_voucher")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.code_voucher) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
    ...
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.fpd.fields.processed_date")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.processed_date) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.fpd.fields.ket")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.ket) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
