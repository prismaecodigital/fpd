...
class LrdApiController extends Controller
{
    ...
    {        
        ...
        return new LrdResource(Fpd::with(['bu', 'dept', 'user'])->advancedFilter()->where('bu_id', $request->id)->whereIn('dept_id', auth()->user()->depts->pluck('id'))->whereIn('status', [4,5,6,7])->paginate(request('limit', 10)));
    }
