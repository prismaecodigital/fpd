      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <p style="color: black">Daftar Penyesuaian Anggaran Antar Periode</p>
          </div>
          <div class="card-body">
...
export default {
  ...
  data() {
    return {
      ...
      query: { sort: 'id', order: 'desc', limit: 100, s: '', bu_id: null, type: 1, status: ['1'] },
      xprops: {
  ...
  computed: {
    ...mapGetters('AdjustmentsPeriodIndex', ['data', 'total', 'loading']),
  ...
  methods: {
    ...mapActions('AdjustmentsPeriodIndex', ['fetchIndexData', 'setQuery', 'resetState', 'massUpdate']),
    updateEndDate(value) {
