      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">
              <strong>Data Cashflow IN [ {{this.selected_bu ? this.selected_bu.name : ''}} ]</strong>
            </h4>
          </div>
          <div class="card-body">
...
export default {
  ...
  computed: {
    ...mapGetters('CashInProjectionsIndex', ['data', 'total', 'loading']),
  ...
  methods: {
    ...mapActions('CashInProjectionsIndex', ['fetchIndexData', 'setQuery', 'resetState']),
    updateEndDate(value) {
